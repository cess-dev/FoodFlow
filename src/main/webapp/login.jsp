    ...
    <div class="auth-container">
        <div class="auth-card">
            <div class="auth-header">
                ...
                <p class="auth-subtitle">Sign in to your FoodFlow account</p>
            </div>
            ...
            <div style="background: rgba(124, 58, 237, 0.1); border: 1px solid rgba(124, 58, 237, 0.3); border-radius: var(--radius-sm); padding: 12px; margin-bottom: 20px; font-size: 12px; color: var(--text-secondary);">
                ...
                <strong>Login with your Full Name</strong> (e.g., "Admin User", "Test User")
            </div>
            ...
            <div class="auth-footer">
                <p>Don't have an account? <a href="signup.jsp" class="auth-link">Sign Up</a></p>
            </div>
        </div>
    </div>
